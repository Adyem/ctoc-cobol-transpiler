>>SOURCE FORMAT IS FREE
       ...
       01 CBLC-EX-PAYLOAD-RANGE-ERROR.
       05 CBLC-EX-PAYLOAD-RANGE-ERROR-CODE PIC S9(9).
       LINKAGE SECTION.
       01 CBLC-EX-CONTEXT.
       ...
       F.
           ...
           IF CBLC-EX-RAISING = 'Y' OR CBLC-EX-CLEANING = 'Y'
               MOVE 149161737 TO CBLC-EX-SECONDARY-TYPE-ID
           ...
           MOVE F-ERROR TO CBLC-EX-PAYLOAD-RANGE-ERROR
           MOVE 4 TO CBLC-EX-PAYLOAD-SIZE
           MOVE 149161737 TO CBLC-EX-TYPE-ID
           MOVE 149161737 TO CBLC-EX-DYNAMIC-TYPE-ID
           MOVE 45 TO CBLC-EX-SOURCE-LINE
           MOVE 2856383468 TO CBLC-EX-SOURCE-FILE-ID
           ...
           GOBACK
           ELSE
           COMPUTE F-RESULT = FUNCTION EXP(F-OPERAND)
           END-IF.
