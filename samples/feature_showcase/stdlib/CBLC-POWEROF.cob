>>SOURCE FORMAT IS FREE
       ...
       01 CBLC-EX-PAYLOAD-DOMAIN-ERROR.
       05 CBLC-EX-PAYLOAD-DOMAIN-ERROR-CODE PIC S9(9).
       LINKAGE SECTION.
       01 CBLC-EX-CONTEXT.
       ...
       01 F-BASE USAGE COMP-2.
       01 F-EXPONENT USAGE COMP-2.
       01 CBLC-RETURN-F USAGE COMP-2.
       PROCEDURE DIVISION USING CBLC-EX-CONTEXT
            BY REFERENCE F-BASE BY REFERENCE F-EXPONENT
            BY REFERENCE CBLC-RETURN-F.
       F.
           COMPUTE F-RESULT = 0.
           IF F-BASE = 0 AND F-EXPONENT <= 0
           COMPUTE F-ERROR-CODE = 1
           IF CBLC-EX-RAISING = 'Y' OR CBLC-EX-CLEANING = 'Y'
               MOVE 194328251 TO CBLC-EX-SECONDARY-TYPE-ID
           ...
           MOVE F-ERROR TO CBLC-EX-PAYLOAD-DOMAIN-ERROR
           MOVE 4 TO CBLC-EX-PAYLOAD-SIZE
           MOVE 194328251 TO CBLC-EX-TYPE-ID
           MOVE 194328251 TO CBLC-EX-DYNAMIC-TYPE-ID
           MOVE 45 TO CBLC-EX-SOURCE-LINE
           MOVE 2518638522 TO CBLC-EX-SOURCE-FILE-ID
           ...
           ELSE
           IF F-BASE < 0
           COMPUTE F-RESULT = FUNCTION INTEGER-PART(F-EXPONENT)
           IF F-EXPONENT NOT = F-RESULT
           COMPUTE F-ERROR-CODE = 1
           IF CBLC-EX-RAISING = 'Y' OR CBLC-EX-CLEANING = 'Y'
               MOVE 194328251 TO CBLC-EX-SECONDARY-TYPE-ID
               MOVE 55 TO CBLC-EX-SECONDARY-SOURCE-LINE
               MOVE 17 TO CBLC-EX-SECONDARY-SOURCE-COLUMN
               PERFORM CBLC-TERMINATE
           END-IF
           MOVE 'Y' TO CBLC-EX-RAISING
           MOVE F-ERROR TO CBLC-EX-PAYLOAD-DOMAIN-ERROR
           ...
           MOVE 194328251 TO CBLC-EX-TYPE-ID
           MOVE 194328251 TO CBLC-EX-DYNAMIC-TYPE-ID
           MOVE 55 TO CBLC-EX-SOURCE-LINE
           MOVE 2518638522 TO CBLC-EX-SOURCE-FILE-ID
           MOVE 17 TO CBLC-EX-SOURCE-COLUMN
           MOVE 'Y' TO CBLC-EX-PAYLOAD-OWNER
           MOVE 'Y' TO CBLC-EX-ACTIVE
           MOVE 'N' TO CBLC-EX-RAISING
           GOBACK
           ELSE
           COMPUTE F-RESULT = F-BASE ** F-EXPONENT
           END-IF
           ELSE
           COMPUTE F-RESULT = F-BASE ** F-EXPONENT
           END-IF
