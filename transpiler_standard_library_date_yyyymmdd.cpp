...
int transpiler_standard_library_generate_date_yyyymmdd(char **out_text)
{
    ...
    *out_text = NULL;
    template_text =
        ...
        "               MOVE " TRANSPILE_STANDARD_LIBRARY_STATUS_LITERAL_RANGE_ERROR " TO LNK-STATUS\n"
        "               GO TO VALIDATION-EXIT\n"
        "           END-IF\n"
        ...
        "               MOVE " TRANSPILE_STANDARD_LIBRARY_STATUS_LITERAL_DOMAIN_ERROR " TO LNK-STATUS\n"
        "               GO TO VALIDATION-EXIT\n"
        "           END-IF\n"
        ...
        "       VALIDATION-EXIT.\n"
        "           IF LNK-STATUS NOT = " TRANSPILE_STANDARD_LIBRARY_STATUS_LITERAL_SUCCESS "\n"
        "               MOVE 0 TO LNK-YEAR\n"
        "               MOVE 0 TO LNK-MONTH\n"
        "               MOVE 0 TO LNK-DAY\n"
        "               MOVE 0 TO LNK-PACKED\n"
