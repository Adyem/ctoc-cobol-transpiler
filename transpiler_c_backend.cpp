...
static int c_backend_emit_helper_functions(t_c_backend_buffer *buffer)
{
    if (!buffer)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "static size_t cblc_min_size(size_t left, size_t right)")
        != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (left < right)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        return (left);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    return (right);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "static size_t cblc_string_length(const char *text)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (!text)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        return (0);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    length = 0;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (text[length] != '\\0')") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        length += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    return (length);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t literal_length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t index;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    literal_length = cblc_string_length(literal);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (literal_length > capacity)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        literal_length = capacity;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    index = 0;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < literal_length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        buffer[index] = literal[index];") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        index += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < capacity)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        buffer[index] = ' ';") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        index += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        *length = literal_length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t copy_length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t index;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    copy_length = source_length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (copy_length > destination_capacity)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        copy_length = destination_capacity;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    index = 0;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < copy_length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        destination[index] = source[index];") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        index += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < destination_capacity)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        destination[index] = ' ';") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        index += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (destination_length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        *destination_length = copy_length;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    copy_length = cblc_min_size(destination_length, source_length);")
        != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    index = 0;") != FT_SUCCESS)
        return (FT_FAILURE);
    ...
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < destination_length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        destination[index] = ' ';") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer,
            "static void cblc_display_string(const char *buffer, size_t length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t index;") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (!buffer)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        return ;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    index = 0;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    while (index < length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    {") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        fputc(buffer[index], stdout);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        index += 1;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    }") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    fputc('\\n', stdout);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer,
            "static void cblc_display_char_buffer(const char *buffer, size_t length)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    size_t index;") != FT_SUCCESS)
    ...
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "static void cblc_display_int(int value)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    printf(\"%d\\n\", value);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "static void cblc_display_size(size_t value)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    printf(\"%zu\\n\", value);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "static void cblc_display_literal(const char *literal)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "{") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    if (!literal)") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "        return ;") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "    printf(\"%s\\n\", literal);") != FT_SUCCESS)
        return (FT_FAILURE);
    if (c_backend_buffer_append_line(buffer, "}") != FT_SUCCESS)
        return (FT_FAILURE);
    return (FT_SUCCESS);
