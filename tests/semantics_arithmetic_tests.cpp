...
FT_TEST(test_semantics_accepts_mixed_floating_move_subtraction)
{
    t_transpiler_context context;
    t_ast_node *program;
    t_ast_node *expression;
...
const t_test_case *get_semantics_arithmetic_tests(size_t *count)
{
    static const t_test_case tests[] = {
        ...
        {"semantics_accepts_mixed_floating_move_addition", test_semantics_accepts_mixed_floating_move_addition},
        {"semantics_accepts_mixed_floating_move_subtraction", test_semantics_accepts_mixed_floating_move_subtraction},
