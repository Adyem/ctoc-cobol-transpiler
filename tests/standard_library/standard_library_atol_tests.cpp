...
FT_TEST(test_standard_library_atol_converts_large_value)
{
    ...
    driver_text =
        ...
        "       DATA DIVISION.\n"
        "       WORKING-STORAGE SECTION.\n"
        "       01 INPUT-TEXT PIC X(32) VALUE \"123456789012345678\".\n"
        "       01 INPUT-LENGTH PIC S9(9) COMP-5 VALUE +18.\n"
        "       01 OUTPUT-RESULT PIC S9(18) VALUE 000000000000000000.\n"
        "       01 OUTPUT-STATUS PIC 9 VALUE 0.\n"
        "       01 RESULT-DISPLAY PIC -9(18).\n"
        "       PROCEDURE DIVISION.\n"
        "           CALL 'CBLC-ATOL' USING BY REFERENCE INPUT-TEXT\n"
...
FT_TEST(test_standard_library_atol_detects_overflow)
{
    ...
    driver_text =
        ...
        "       DATA DIVISION.\n"
        "       WORKING-STORAGE SECTION.\n"
        "       01 INPUT-TEXT PIC X(32) VALUE \"1234567890123456789\".\n"
        "       01 INPUT-LENGTH PIC S9(9) COMP-5 VALUE +19.\n"
        "       01 OUTPUT-RESULT PIC S9(18) VALUE 000000000000000000.\n"
        "       01 OUTPUT-STATUS PIC 9 VALUE 0.\n"
        "       01 RESULT-DISPLAY PIC -9(18).\n"
        "       PROCEDURE DIVISION.\n"
